 ...
 * Run with: node test-image-validation.js
 *
...
// Import validation functions (we'll use dynamic import for ES modules)
async function runTests() {
  ...
  try {
    ...
    console.log(
      ...
      !validateFileMagicNumber(invalidBuffer) ? 'PASS' : 'FAIL'
    );
